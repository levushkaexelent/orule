...
local CHANGELOG_VERSION = "1.7" -- Версия changelog'а, меняй при каждом обновлении
...
imgui.OnFrame(function()
    return shouldProcessImGui() or show_changelog_window[0] or (orule.config.autoInsertEnabled and sampIsChatInputActive())
end, function()
    imgui.Process = shouldProcessImGui() or show_changelog_window[0]
